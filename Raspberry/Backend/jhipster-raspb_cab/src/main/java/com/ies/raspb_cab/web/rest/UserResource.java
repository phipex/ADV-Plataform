...
public class UserResource {
    ...
    @Autowired
    BillAcepterService billAcepter;
    /*
    @Autowired
    CodeLectorService codeLector;
    @Autowired
    CodePrinterService codePrinter;
    */
    ...
    public ResponseEntity<Object> enable() {
        ...
        billAcepter.enableBill();
        //codeLector.enableLector();
        //codePrinter.enablePrinter();

        //counterService.increaseCounter(2000);
    ...
    public ResponseEntity<Object> disable() {
        ...
        billAcepter.disableBill();
        //codeLector.disableLector();
        //codePrinter.disablePrinter();
